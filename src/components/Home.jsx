...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "We provide comprehensive training materials, including video tutorials, user guides, and webinars to help you maximize the platform's potential.",
  },
  {
...
function Home() {
  ...
  return (
    <div className='flex flex-row max-sm: overflow-hidden'>
      <section className='h-screen bg-blue-500 text-white w-2/5 flex flex-col justify-center items-center p-5'>
        <div className='p-5 h-96 w-full flex flex-row justify-center gap-3'>
          <div
            className='border border-slate-300 p-10 bg-cover'
            style={{ backgroundImage: 'url("/split1.jpg")' }}></div>
          <div
            className='border border-slate-300 p-10 relative bottom-10 bg-cover'
      ...
      <section className='bg-slate-50 text-black h-screen w-4/5 p-10 flex flex-col overflow-y-auto'>
